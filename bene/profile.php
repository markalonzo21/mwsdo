          ...
          <form class="form-donation" id="editprofile_f" method="post">
               <div class="row">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group col-md-12">
                          <button type="submit" class="btn btn-primary pull-right btn-round" name="addd">Update Profile</button> 
                      </div>
...
<script>
    function get_profile(){
        ...
        tbod.innerHTML="";
        $.ajax({
            url: host + "select_proc/beneficiary.php",
            method:"POST",
            data:{},
            success:(e)=>{ 
                console.log('data:', e);
    ...
    editprofile_f.addEventListener('submit', (e) => {
        e.preventDefault();
        $.ajax({
            url: host + 'panel_proc/edit_bene_profile.php',
            method: "POST",
