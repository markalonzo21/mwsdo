<?php
    ...
    $ret=mysqli_query($con,"select donorname, contact from tbl_donor where d_id='$donid'");
    $row=mysqli_fetch_array($ret);
    $fullname=$row['donorname'];
    $contact=$row['contact'];
...
<div class="sidebar">
    <ul class="sidebar-nav-container">
        ...
        <li class="sidebar-nav-item"><a href="#" data-target="#donatesModal" data-toggle="modal">Donate Now</a></li>
        <!-- <li class="sidebar-nav-item"><a href="#">Donation Details</a></li> -->
            ...
            <ul class="nav navbar-nav" id="ang_nav">
                ...
                <li class="dropdown">
                    <a id="dLabel" data-target="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        <span><?php echo ucfirst($fullname); ?></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="#" onclick="window.location.href = 'profile.php'" class="dropdown-menu-link">My Profile</a></li>
                        <li><a href="#" class="dropdown-menu-link" onclick="open_pass(2)" data-target="#cModal" data-toggle="modal">Change Password</a></li>
